    ...
    return(
        <div className="container">
          <form className="form">
             ...
             <input type="text" name="fechaAsignada" onChange={handleChange} value={tratamiento.fechaAsignada}></input>
             <label>Descripcion:</label>
             <textarea type="text" name="descripcion" onChange={handleChange} value={tratamiento.descripcion} rows={3}></textarea>
             <label>Fecha Inicio:</label>
             <input type="text" name="fechaInicio" onChange={handleChange} value={tratamiento.fechaInicio}></input>
             <label>Fecha Fin:</label>
             <input type="text" name="fechaFin" onChange={handleChange} value={tratamiento.fechaFin}></input>
